 ...
 * @author RojeruSan
 */
public class Pn_Cargo extends javax.swing.JPanel {
  ...
  public void bloquearComponentes() {
    ...
    public void ComponenteEditable() {
        ...
        t_cargo.setEditable(true);

    }

    public void limpiarCampos() {

        t_cargo.setText("Ingrese Cargo");
        id = 0;
        descripcion = "";
    ...
    public Boolean validarEscritura() {
        ...
        if (!(t_cargo.getText().equals("Ingrese Cargo")) && !(t_cargo.getText().equals(""))) {
            t_cargo.setBorder(null);
            lb_errorCargo.setText("");
        } else {

            t_cargo.setBorder(new LineBorder(Color.RED, 1));
            lb_errorCargo.setText("Ingrese un cargo válido");
    ...
    private void initComponents() {
        ...
        lb_errorCargo = new javax.swing.JLabel();
        ...
        jLabel8.setText("Módulo de Cargo");
        ...
        jLabel23.setText("Ingreso de Nuevo Cargo");
        add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 180, -1));
        ...
        t_cargo.setForeground(new java.awt.Color(153, 153, 153));
        t_cargo.setText("Ingrese Cargo");
        t_cargo.setBorder(null);
        t_cargo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                t_cargoFocusLost(evt);
            }
        });
        t_cargo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                t_cargoMouseClicked(evt);
            }
        });
        t_cargo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_cargoActionPerformed(evt);
            }
        });
        t_cargo.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(t_cargo, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                    .addComponent(lb_errorCargo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lb_errorCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        add(bt_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, 140, -1));
        ...
        add(bt_cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 140, -1));
        ...
        add(bt_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, 140, -1));
        ...
        add(lb_errorCampos, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 370, 260, 20));
        ...
        add(bt_nuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 140, -1));

        t_empleado.setForeground(new java.awt.Color(153, 153, 153));
        t_empleado.setText("Ingrese Cargo");
        ...
        add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 140, 180, 10));
    ...
    private void t_cargoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_t_cargoFocusLost
        if (t_cargo.getText().trim().equals("")) {
            t_cargo.setText("Ingrese Cargo");
            t_cargo.setForeground(new Color(153, 153, 153));

        }

        // TODO add your handling code here:
    }//GEN-LAST:event_t_cargoFocusLost

    private void t_cargoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_cargoMouseClicked
        // TODO add your handling code here:

        t_cargo.setText("");
    }//GEN-LAST:event_t_cargoMouseClicked

    private void t_cargoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_cargoActionPerformed
        t_cargo.setText("");
        // TODO add your handling code here:
    }//GEN-LAST:event_t_cargoActionPerformed
    ...
    private void t_cargoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_cargoKeyTyped
        ...
        if (!Character.isLetter(tecla) && tecla != KeyEvent.VK_SPACE && tecla != KeyEvent.VK_BACK_SPACE && tecla != KeyEvent.VK_ENTER) {
            getToolkit().beep();
            lb_errorCargo.setText("No se admiten números");
            evt.consume();
    ...
    }//GEN-LAST:event_t_cargoKeyTyped
...
//sin lineas verticles
    ...
    private javax.swing.JLabel lb_errorCargo;
