...
public class Pn_Descuentos extends javax.swing.JPanel {
    ...
    public void cargarTabla() {
     ...
     public void tamañoTabla() {
        TableColumnModel columnModel = jt_Descuentos.getColumnModel();
    ...
    public void ComponenteEditable() {
        ...
        t_descuento.setEditable(true);

    }

    public void limpiarCampos() {

        t_descuento.setText("Ingrese Descuento");
        id = 0;
        descripcion = "";
    ...
    public Boolean validarEscritura() {
        ...
        if (!(t_descuento.getText().equals("Ingrese Descuento")) && !(t_descuento.getText().equals(""))) {
            t_descuento.setBorder(null);
            lb_errorDescuento.setText("");
        } else {

            t_descuento.setBorder(new LineBorder(Color.RED, 1));
            lb_errorDescuento.setText("Ingrese un Descuento válido");
    ...
    private void initComponents() {
        ...
        lb_errorDescuento = new javax.swing.JLabel();
        ...
        jLabel8.setText("Módulo de Descuentos");
        ...
        t_descuento.setForeground(new java.awt.Color(153, 153, 153));
        t_descuento.setText("Ingrese Descuento");
        t_descuento.setBorder(null);
        ...
        t_descuento.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                t_descuentoMouseClicked(evt);
            }
        });
        ...
        t_descuento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                t_descuentoKeyTyped(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(100, 100, 100)
                        .addComponent(lb_errorDescuento, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(t_descuento, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lb_errorDescuento, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel23.setText("Buscar Descuento");
...
// cargarTabla();
    ...
    private void t_descuentoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_t_descuentoFocusLost
        if (t_descuento.getText().trim().equals("")) {
            t_descuento.setText("Ingrese Extra");
            t_descuento.setForeground(new Color(153, 153, 153));
    ...
    private void t_descuentoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_descuentoMouseClicked
        // TODO add your handling code here:

        t_descuento.setText("");
    }//GEN-LAST:event_t_descuentoMouseClicked
    ...
    private void t_descuentoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_descuentoKeyTyped
        ...
        if (!Character.isLetter(tecla) && tecla != KeyEvent.VK_SPACE && tecla != KeyEvent.VK_BACK_SPACE && tecla != KeyEvent.VK_ENTER) {
            getToolkit().beep();
            lb_errorDescuento.setText("No se admiten números");
            evt.consume();
    ...
    }//GEN-LAST:event_t_descuentoKeyTyped
...
//sin lineas verticles
        ...
        /*jt_Extras.getColumnModel().getColumn(2).setPreferredWidth(50);
         ...
         jt_Extras.getColumn(3).setPreferredWidth(50);*/
    }
